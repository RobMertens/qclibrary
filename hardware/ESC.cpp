...
ESC::ESC(void)
{	
	_ddr  = &ESC_DDR;						// Put definitions in local variables.
	_pin  = &ESC_PIN;
	_port = &ESC_PORT;
 ...
 * 	Constructor for the ESC-class. By making an object with this constructor
 *	all local variables are set together with the avr-timer. This constructor
 *	is for ESC's with different microseconds PWM-ranges like mine which has a
 *	minimum of 700us and a maximum of 2000us.
 *
 *	@param minMicrosecond The length of the minimum PWM-pulse in microseconds.
 *	@param maxMicrosecond The length of the maximum PWM-pulse in microseconds.
 ******************************************************************************/
ESC::ESC(int minMicrosecond, int maxMicrosecond)
{	
	_ddr  = &ESC_DDR;						// Put definitions in local variables.
	_pin  = &ESC_PIN;
	_port = &ESC_PORT;
